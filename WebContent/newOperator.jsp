							...
							<TBODY>
								<TR>
									...
									<TD width=165 height="29" bgColor=#7691c7>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<A
										class=nav href="newOperator.jsp">新增操作员</A></TD>
								</TR>
								<TR>
				...
				<TR vAlign=top>
					<TD height="600" bgColor=#f1f3f9>
						<form method="POST" action="--WEBBOT-SELF--">
							<p>
								登录ID：<input type="text" name="T1" size="20" value="A00000001">
							</p>
							<p>
								姓 名：<input type="text" name="T2" size="20" value="张三">
							</p>
							<p>
								密码：<input type="password" name="T3" size="20" value="******">
							</p>
							<p>
								密码确认：<input type="password" name="T4" size="20" value="******">
							</p>
							<p>
								是否管理员：<input type="radio" value="V1" checked name="R1">是&nbsp;&nbsp;&nbsp;
								<input type="radio" name="R1" value="V2">否
							</p>
							<p>
