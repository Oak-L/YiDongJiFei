				...
				<TR vAlign=top>
					<TD height="600" bgColor=#f1f3f9>
						...
						<form method="POST" action="--WEBBOT-SELF--">
							...
							<p>
								收费金额：<input type="text" name="T1" size="20" value="10">
							</p>
							<p>
						...
						<form method="POST" action="--WEBBOT-SELF--">
							...
							<p>
								收费项目：<input type="checkbox" name="C1" value="ON" checked>开户费
								<input type="checkbox" name="C2" value="ON">漫游费 <input
									type="checkbox" name="C3" value="ON">押金 <input
									type="checkbox" name="C4" value="ON" checked>入网费 <input
									type="checkbox" name="C5" value="ON" checked>选号费
							</p>
							<p>
								<input type="submit" value="提交" name="B1"><input
									type="reset" value="全部重写" name="B2">
