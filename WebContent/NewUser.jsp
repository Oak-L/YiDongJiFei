				...
				<TR vAlign=top>
					<TD height="600" bgColor=#f1f3f9>
						<form method="POST" action="NewUser">
							<p>
								手机号码：<input type="text" name="T1" size="11" maxlength="11">
							</p>
							<p>
								漫游状态：<input type="radio" name="R1" value="V4">省内漫游 <input
									type="radio" name="R1" value="V5">国内漫游 <input
									type="radio" name="R1" value="V6">国际漫游
							</p>
							<p>
								通话级别：<input type="radio" value="V1" name="R2">本地通话 <input
									type="radio" name="R2" value="V2">国内长途 <input
									type="radio" name="R2" value="V3">国际长途
							</p>
							<p>
								客户ID：<input type="text" name="T2" size="20"
									value="${currentCustomer.tcustomerIdNumber }" readonly>
							</p>
							<p>
