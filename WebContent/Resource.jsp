				...
				<TR vAlign=top>
					<TD height="600" bgColor=#f1f3f9>
						<form method="POST" action="Resource">
							<p>
								号码类型：<input type="Radio" name="R1" value="SIM" checked>SIM
								&nbsp;&nbsp;<input type="Radio" name="R1" value="UIM">UIM
							</p>
							<p>
								指定号段：从<input type="text" name="T1" size="20" value=""
									maxlength="11">到<input type="text" name="T2" size="20"
									value="" maxlength="11"><input type="submit" value="提交"
									name="B1"><input type="reset" value="全部重写" name="B2">
							</p>
						</form>
						<hr> ${msg }
					</TD>
