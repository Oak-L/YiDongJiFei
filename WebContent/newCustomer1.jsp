			...
			<TBODY>
				...
				<TR vAlign=top>
					<TD height="600" bgColor=#f1f3f9>
						<form method="POST" action="NewCustomer1">
							<p>证件类型：${currentCustomer.tcustomerIdType }</p>
							<p>证件号码：${currentCustomer.tcustomerIdNumber }</p>
							<p>
								姓名：<input type="text" name="T1" size="20"
									value="${currentCustomer.tcustomerName }">
							</p>
							<p>
								性别：<input type="radio" value="V1" checked name="R1">男&nbsp;&nbsp;
								<input type="radio" name="R1" value="V2">女
							</p>
							<p>
								生日：<input type="text" name="T3" size="20"
									value="${currentCustomer.tcustomerBirthday }">
							</p>
							<p>
								联系地址：<input type="text" name="T4" size="20"
									value="${currentCustomer.tcustomerAddress }">
							</p>
							<p></p>
							<p>
								<input type="submit" value="下一步>>" name="B1"><input
